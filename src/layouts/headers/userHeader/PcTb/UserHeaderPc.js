    ...
    <div className="user-header-container">
      <div className="container">
        <div className="row">
          ...
          >
            <span className="brand-mark__frame" aria-hidden="true">
              S
            </span>
            <span>
              <strong>Satomi</strong> Movie
            </span>
          </button>
              ...
              return (
                <div className="filter-dropdown" key={dropdown.pathPrefix}>
                  <button
                    ...
                    onClick={() =>
                      setOpenMenu(isOpen ? null : dropdown.pathPrefix)
                    }
                  >
                    {dropdown.label}
                  ...
                  <div
                    id={menuId}
                    className={`filter-menu ${dropdown.wide ? "filter-menu--wide" : ""} ${isOpen ? "is-open" : ""}`}
                  >
          ...
          <div className="header-actions">
            ...
            <div className="search-tablet">
              <button
                ...
                aria-expanded={isTabletSearchOpen}
          ...
          {isTabletSearchOpen && (
            <SearchTablet onClose={() => setTabletSearchOpen(false)} />
          )}
        </div>
      </div>
    </div>
